...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{center}
      \includegraphics[width=8cm]{assets/hw_03_1.png}
    \end{center}
    \[ \{x\mid x\text{ contains at most one } a\} \]
    \begin{center}
      \includegraphics[width=8cm]{assets/hw_03_2.png}
    \end{center}
    \[ \{x\mid x\text{ starts with } a\} \]
    \begin{center}
      \includegraphics[width=5cm]{assets/hw_03_3.png}
    \end{center}
    \[ \{x\mid x\text{ has even length}\} \]
    \begin{center}
      \includegraphics[width=5cm]{assets/hw_03_4.png}
    \end{center}
    ...
    \begin{center}
      \includegraphics[width=8cm]{assets/hw_03_l1.png}
    \end{center}
    \[ L_2 \]
    \begin{center}
      \includegraphics[width=8cm]{assets/hw_03_l2.png}
    \end{center}
    \[ L_3 \]
    \begin{center}
      \includegraphics[width=8cm]{assets/hw_03_l3.png}
    \end{center}
  \end{enumerate}
