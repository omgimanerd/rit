...
\begin{enumerate}
  \item that begin or end in \( aa \) in \( bb \).
    \begin{center}
      \includegraphics[width=8cm]{hw_2_1_1.png}
    \end{center}
  \item that do not have \( aaa \) as a substring.
    \begin{center}
      \includegraphics[width=10cm]{hw_2_1_2.png}
    \end{center}
  \item that contain both \( aba \) and \( bab \) as substrings.
    \begin{center}
      \includegraphics[width=15cm]{hw_2_1_3.png}
    \end{center}
  \item whose length is a multiple of 5.
    \begin{center}
      \includegraphics[width=12cm]{hw_2_1_4.png}
    \end{center}
  \item where the number of \( a \)'s after the last \( b \) in the string is
    odd.
    \begin{center}
      \includegraphics[width=8cm]{hw_2_1_5.png}
    \end{center}
\end{enumerate}
