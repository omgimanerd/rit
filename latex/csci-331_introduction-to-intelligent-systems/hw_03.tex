...
\begin{center}
  \begin{tikzpicture}[scale=0.2]
    ...
    \draw (36.6,-29.3) circle (3);
    \draw (36.6,-29.3) node {\( R \)};
    \draw (15.5,-28) circle (3);
    \draw (15.5,-28) node {\( F \)};
    \draw (49.9,-29.3) circle (3);
    \draw (49.9,-29.3) node {\( P \)};
    \draw (34.6,-11.5) circle (3);
    \draw (34.6,-11.5) node {\( S \)};
    \draw (33.7,-46.9) circle (3);
    \draw (33.7,-46.9) node {\( D \)};
    \draw (14.1,-12.6) circle (3);
    \draw (14.1,-12.6) node {\( A \)};
    \draw (25,-38.8) circle (3);
    \draw (25,-38.8) node {\( T \)};
    \draw (53.7,-12.6) circle (3);
    \draw (53.7,-12.6) node {\( G \)};
    \draw (53.7,-12.6) circle (2.4);
    \draw (49,-50.6) circle (3);
    \draw (49,-50.6) node {\( C \)};
    \draw (62.5,-37.7) circle (3);
    \draw (62.5,-37.7) node {\( B \)};
