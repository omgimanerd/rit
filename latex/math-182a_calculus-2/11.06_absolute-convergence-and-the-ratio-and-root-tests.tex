...
\begin{align*}
  a_{n} &= \frac{n^{2}2^{n-1}}{(-5)^{n}} \\
  a_{n+1} &= \frac{(n+1)^{2}2^{n}}{(-5)^{n+1}} \\
  \bigg|\frac{a_{n+1}}{a_{n}}\bigg| &= \bigg|
    \frac{\frac{(n+1)^{2}2^{n}}{(-5)^{n+1}}}
      {\frac{n^{2}2^{n-1}}{(-5)^{n}}}\bigg| \\
  &= \frac{(n+1)^{2}2^{n}5^{n}}{5^{n+1}n^{2}2^{n-1}} \\
  &= \frac{2}{5}(\frac{n+1}{n})^{2} \\
  &= \frac{2}{5}(1+\frac{1}{n})^{2} \\
  &= \frac{2}{5}
\end{align*}
Since \( \frac{2}{5} < 1 \), \( \sum{a_{n}} \) is absolutely convergent.
